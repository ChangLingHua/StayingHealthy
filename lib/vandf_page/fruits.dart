...
class Fru extends StatefulWidget{
  const Fru({Key? key}) : super(key: key);

  @override
  State <Fru> createState() => _Fru();
}

class _Fru extends State<Fru> {

  final Stream<QuerySnapshot> fruit =
                      ...
                      child: Text.rich(
                        TextSpan(text: '建議每天應攝取至少 ',style: TextStyle(color: Colors.black,fontSize: 16),
                          children: [
                            ...
                            TextSpan(text: '(2個成人的拳頭大小)',style: TextStyle(color: Colors.black,fontSize: 16)),
                          ],
                        ),
                      ),
                    ),
                        ...
                        return Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('${data.docs[index]['kcal']} / 100g',style: TextStyle(color: Colors.black54,fontSize: 15),),
